...
<div id="header-wrap"><header>
    ...
    <nav>
		<ul>
			...
			<li><a href="#messages.html">Messages</a><span></span></li>
			<li><a href="#uSettings.html">User Settings</a><span></span></li>
		</ul>
	</nav>
        ...
        <div id="main">
			...
			<aside>
               	    <div class="post-meta">
                  	    <h4>Post Info</h4>
                     	<ul>
                           <li class="comment"><a href="#">New Message</a></li>
                           <li class="comment"><a href="#">Inbox</a></li>
                           <li class="comment"><a href="#">Deleted</a></li>
                        </ul>
					</div>
